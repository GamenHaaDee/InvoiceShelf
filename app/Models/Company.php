...
class Company extends Model implements HasMedia
{
    ...
    {
        $prepared = Branding::prepare($branding);

        if (empty($prepared)) {
            return;
        }

        CompanySetting::setSettings($prepared, $this->id);
    }
    ...
    public function setupDefaultSettings()
    {
        ...
        CompanySetting::setSettings(array_merge($settings, Branding::defaults()), $this->id);
    }
